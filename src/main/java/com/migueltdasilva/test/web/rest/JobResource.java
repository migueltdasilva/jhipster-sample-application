...
import com.migueltdasilva.test.domain.Job;
import com.migueltdasilva.test.repository.JobRepository;
...
/**
 * REST controller for managing {@link com.migueltdasilva.test.domain.Job}.
 */
@RestController
@RequestMapping("/api")
@Transactional
